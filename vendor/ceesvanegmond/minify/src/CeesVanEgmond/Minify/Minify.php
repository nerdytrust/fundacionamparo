...
class Minify
{
  ...
  public function javascript($file, $attributes = array()) {
    ...
    $this->buildPath = isset($attributes['js_build_path']) ? "/".$attributes['js_build_path'] : $this->config['js_build_path'];
    unset($attributes['js_build_path']);
  ...
  public function stylesheet($file, $attributes = array()) {
    ...
    $this->buildPath = isset($attributes['css_build_path']) ? $attributes['css_build_path'] : $this->config['css_build_path'];
    unset($attributes['css_build_path']);
    $this->attributes = $attributes;
