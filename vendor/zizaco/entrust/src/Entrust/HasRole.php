...
trait HasRole
{
    ...
    {
        return $this->hasMany(Config::get('entrust::role'),  'id_roles', 'id_roles');
    }
    ...
    public function can($permission)
    {
        ...
        foreach ($this->roles as $role) {
            ...
            foreach ($this->perms as $perm) {
                ...
                if ($perm->name == $permission and $perm->pivot->deny == "True") {
                    return true;
                }else
            ...
            foreach ($role->perms as $perm) {
                ...
                if ($perm->name == $permission and !in_array($perm->name, $user_perms)) {
                    return true;
                }
            }
    ...
    public function perms()
    {
        ...
        try {
            return $this->belongsToMany(Config::get('entrust::permission'), Config::get('entrust::permission_user_table'),'id_users','id_permissions')->withPivot('id_permissions_users','deny');
        } catch (Exception $e) {
            // do nothing
        }
    }
