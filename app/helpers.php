...
class Helper {
	...
	public static function facebookShare( $after = '', $url, $before = '' ){
		$fb_share = '<a href="https://www.facebook.com/dialog/share?app_id=776167932490026&href=' . $url . '&display=popup&redirect_uri=' . URL::to('facebook-close') . '" onclick="return !window.open(this.href, \'Share on Facebook\', \'width=640, height=536\')">' .$after . '<li class="fa fa-facebook"></li>' . $before . '</a>';
