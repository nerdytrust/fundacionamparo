...
class Helper {
	...
	public static function facebookShare( $after = '', $url, $before = '' ){
		$fb_share = '<a href="https://www.facebook.com/dialog/share?app_id=776167932490026&href=' . $url.'?v='.str_random(10) . '&display=popup&redirect_uri=' . URL::to('facebook-close') . '" onclick="return fbs_click(640, 536, this)">' .$after . '<li class="fa fa-facebook"></li>' . $before . '</a>';
	...
	public static function getAvatar() {
		...
		$avatar = Profiles::where('email', $session->getHybridAuth()->email )->first();
		if($avatar->photoURL!='')
