...
class Profiles extends Crud {
    ...
    */
    ...
    protected $crud = [
        ...
        "not_in_export" => ['browser','ip','created_by', 'updated_by', 'updated_at', 'created_at','userName','zip','coverInfoURL','address','phone','emailVerified','age','language','description','photoURL','profileURL','webSiteURL','identifier','id_registrados','username','country'],
