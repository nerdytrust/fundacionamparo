...
class UsersNotes extends \Crud {


    protected $primaryKey = 'id_users_notes'; // !important
    ...
    */
    ...
    protected $crud = [
        ...
        //
        "fk_column" => ["id_users" => ["first_name","last_name"]],
        // 
        // Tabs
        ...
        "not_in_index"  => ["id_users","created_at","updated_at"],
