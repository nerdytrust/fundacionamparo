...
class Videos extends \Crud {
    ...
    protected $primaryKey = 'id_videos'; // !important
   ...
   protected $crud = [
        ...
        "not_in_index"  => [ 'id_videos', 'video', 'activo', 'created_at', 'updated_at', 'created_by', 'updated_by' ],
