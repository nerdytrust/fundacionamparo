...
class Membresias extends \Crud {


    protected $primaryKey = 'id_membresias'; // !important
    ...
    public function getResenaAttribute( $value ){
   ...
   protected $crud = [
        ...
        "btn_in_index"  => [ "create", "edit", "delete","search","advance-search"],
