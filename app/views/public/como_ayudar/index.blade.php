				...
				<div class="txt_fundacion2">
					...
					@if ( isset( $videos ) )
						@foreach ( $videos as $video )
							<div class="vi2">
								<video id="video" controls loop preload="auto" poster="{{ asset( 'path_image/' . $video->cover . '/' . '960x520' ) }}" class="video-js vjs-default-skin" data-setup="{}" style="background-color: white">
