	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:'Open Sans', sans-serif" width="700px">
		...
		<tr>
			<td style="font-size:15px">
				<h2 style="margin-top:0px;margin-bottom:0px;color:#beda3e;">¡Juntos cumplimos sueños! </h2>
				<p style="margin-top:5px;color:#c2c2c2;">Fundación Amparo agradece tu donativo, con él estás contribuyendo a continuar trabajando a favor del desarrollo cultural y social de México.   </p>
			</td>
		</tr>
		<tr>
			<td style="font-size:15px">
				<p style="margin-top:0px;">Muestra tu altruismo al mundo y compártelo en tus redes sociales</p>
