	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:'Open Sans', sans-serif" width="700px">
		...
		<tr>
			<td style="font-size:15px">
				...
				<p style="margin-top:5px;color:#c2c2c2;">Queremos agradecerte por contactar a Fundación Amparo. Te informamos que recibimos correctamente tu mensaje y fue canalizado al área correspondiente.  </p>
			</td>
		</tr>
		<tr>
			<td style="font-size:15px">
				<p style="margin-top:0px;color:#000;">Pronto uno de nuestros asesores se comunicará contigo. </p>
				<p style="margin-top:5px;color:#000;">¡Saludos! </p>
				<p style="margin-top:5px;color:#c2c2c2;">*Equipo de Fundación Amparo: este es un correo informativo, favor de no responder. </p>
			</td>
		</tr>
		<tr>
