	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:'Open Sans', sans-serif" width="700px">
		...
		<tr>
			<td style="font-size:15px">
				...
				<p style="margin-top:5px;color:#c2c2c2;">Nos alegra comunicarte que la causa <strong style="color:#000">'{{$causa}}'</strong> fue aprobada y gracias a ti, será apoyada por Fundación Amparo.  </p>
			</td>
		</tr>
		<tr>
			<td style="font-size:15px">
				<p style="margin-top:0px;color:#c2c2c2;">Agradecemos tu confianza en nuestra Institución para brindar ayuda a quienes más lo necesitan </p>
			</td>
		</tr>
		<tr>
			<td style="font-size:15px">
				<p style="margin-top:0px;color:#c2c2c2;">Ahora, ayúdanos a que más personas se enteren y se sumen a la causa. ¡Compártela en tus redes sociales! </p>
			</td>
		</tr>
		<tr>
