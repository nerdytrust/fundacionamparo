					...
					{{ Form::open( [ 'url' => 'paso-dos-donacion', 'id' => 'form_step_two_donacion', 'method' => 'POST', 'autocomplete' => 'off', 'role' => 'form' ] )}}
						...
						<div class="vol" id="form_recibo_2" style="display:none;">
							...
							<span class="form-group">
								{{ Form::text( 'r_nombre', Input::old( 'r_nombre'), [ 'placeholder' => 'Nombre', 'id' => 'r_nombre', 'class' => 'form-control'] ) }}
							</span>
							
							<p>RFC</p>
							<span class="form-group">
								{{ Form::text( 'r_rfc', Input::old( 'r_rfc' ), [ 'id' => 'r_rfc', 'placeholder' => 'RFC', 'class' => 'form-control' ] ) }}
							</span>

							<p>Domicilio Fiscal</p>
							<span class="form-group">
								{{ Form::text( 'r_domicilio_fiscal', Input::old( 'r_domicilio_fiscal' ), [ 'id' => 'r_domicilio_fiscal', 'placeholder' => 'Domicilio Fisca', 'class' => 'form-control' ] ) }}
							</span>

							<p>Email</p>
							<span class="form-group">
								{{ Form::email( 'r_email', Input::old( 'r_email' ), [ 'id' => 'r_email', 'placeholder' => 'Correo electrónico', 'class' => 'form-control' ] ) }}
							</span>
