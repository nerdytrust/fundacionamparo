		...
		<section id="Contenedor">
				...
				<div class="txt_mask">
					...
					<nav class="social_mask">
						<ul>
							...
							{{ Helper::twitterShare( 'La Fundación - Cultura', Request::url(), '' ) }}
			...
			<section id="contenedor_int">
				...
				<div class="txt_fundacion2">
					...
					<p>El principal esfuerzo de la Fundación Amparo IAP ha estado enfocado, a través del tiempo, a auspiciar y fomentar actividades ligadas con nuestra cultura, un ejemplo de ello, ha sido la de fomentar en el pueblo de México la conciencia de sus raíces y del incalculable legado cultural de sus antepasados. Motivado por esta inquietud, la Fundación Amparo IAP decidió apoyar las labores de rescate del Templo Mayor en el centro de la ciudad de México, permitiendo poner al descubierto los vestigios de esta grandiosa construcción, al mismo tiempo que conformar la valiosa colección de obras de arte que se exponen en el Museo del Templo Mayor, que ofrece al público el panorama de la cultura mexica en todo su esplendor.</p>
					<br/>
					<p>La obra magna de la Fundación Amparo IAP, es sin duda alguna el Museo Amparo. Habiendo sido Don Manuel Espinosa Yglesias su fundador y oriundo de la Ciudad de Puebla, tuvo especial interés en que fuese ésta la ciudad que albergara, en espacios ligados a su pasado familiar y a importantes centros de la sociedad poblana, un museo. Este museo, a través del tiempo, se ha ganado un lugar y un prestigio dentro del mundo cultural, poniendo al alcance de la humanidad una importante colección de piezas prehispánicas, así como de arte de virreinal, abarcando, incluso las épocas moderna y contemporánea.</p>
					<br/>
