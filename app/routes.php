...
Route::get( 'ficha-causas/{id}/{name}', 'CoversController@fichaCausas' )->where( 'id' , '[0-9]+'); 
Route::get( 'ficha-causas/{id}/{name}/{impulsor}', 'CoversController@fichaCausas' )->where( 'id' , '[0-9]+'); 
...
Route::get( 'recibo', 'DonacionesController@reciboDonacion' );
