...
(function (root, factory) {
    ...
    var regex = /.+\.(gif|jpe?g|png|webp|mp4)/i;
    ...
    function hideOverlay() {
        var element = document.getElementsByTagName("figure");
    ...
    function loadImage(index, callback) {
        ...
        image.setAttribute('id','ligthbox_video');
        ...
        document.getElementById('ligthbox_video').addEventListener('ended',myHandler,false);
